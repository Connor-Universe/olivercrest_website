...
<div class="wrapper">
        ...
        <div class="dash">
            <div class="container">
                ...
                <h3 class="first">
                          ...
                          <form action="add_penalty.php" method = "GET"  name="member">
                ...
                <div class="row">
                 ...
                 if(isset($_GET['success'])){
                  ...
                  <strong>Success</strong> Penalty Successfully Added
                </div> ";
                 }else{
                   $success = "";
                 }
    ...
    $get_funds = "SELECT SUM(amount) AS value_adds FROM penalty where id_no = $id_no";
    ...
    <td class='text-right'>
       <form action='../include/penalty.php' method='POST' id ='$id_no'>
    ...
    <div class='modal-dialog' role='document'>
      <div class='modal-content'>
        ...
        <div class='modal-body'>
          <p>Are you sure you want to add penalty to this users account? You won't be able to undo this action! .</p>
        </div>
...
<ul class="pagination justify-content-center" style="padding-top:30px;">
                                 <?php
                                       ...
                                       if(isset($_GET['member'])){
                                        $member = $_GET['member'];
                                        $prev="<li class='page-item'><a class='page-link btn btn-danger' href='add_penalty.php?page=$previous&&member=$member&&member=#start'>Previous</a></li>";
                                        $reset="<li class='page-item'><a class='page-link btn btn-info' href='add_penalty.php'>Reset</a></li>";
                                        $nxt ="<li class='page-item'><a class='page-link btn btn-primary' href='add_penalty.php?page=$next&&member=$member&&member=#start'>Next</a></li>";
                                      }  else{
                                        $prev="<li class='page-item'><a class='page-link btn btn-danger' href='add_penalty.php?page=$previous#start'>Previous</a></li>";
                                        $reset="<li class='page-item'><a class='page-link btn btn-info' href='add_penalty.php'>Reset</a></li>";
                                        $nxt ="<li class='page-item'><a class='page-link btn btn-primary' href='add_penalty.php?page=$next#start'>Next</a></li>";
                                      }   
                                  if($page == 1){
                                    $prev = "<li class='page-item disabled'><a class='page-link btn btn-danger' href='add_penalty.php'>Previous</a></li>";
                                }
                                if($page == $pages OR $query_result == 0){
                                    $nxt="<li class='page-item disabled'><a class='page-link btn btn-primary' href='add_penalty.php?page=$next'>Next</a></li>";
                                }
                                 ?>
<?php echo"$prev";?>
<?php echo"$reset";?>
