...
$limit = 20;
 ...
 $start = ($page - 1) * $limit;
 $get_post1 = "select count(*) from investment_request where verified = 1";
...
$start = ($page - 1) * $limit;
$get_post2 = "select count(*) from investment_request where id_no like '%$search1%' AND verified = 1";
...
$previous = $page - 1;
$next = $page + 1;
$get_user1 = "select * from investment_request where id_no like '%$search1%' AND verified= 1 order by id DESC limit $start,$limit";
$run_user1 = mysqli_query($connect,$get_user1);

$sql = "select * from investment_request where id_no like '%$search1%' AND verified=1 limit $start,$limit";
$result = mysqli_query($connect, $sql);
$query_result = mysqli_num_rows($result);
        ...
        <div class="dash">
            <div class="container">
                ...
                <div class="col-lg-6">
                 ...
                 <form action="deposit_history.php" method = "GET"  name="member">
                    ...
                    <div class="col-lg-6">
                        <h3 class="first">
                         Filter
                          ...
                          <form action="deposit_history.php" method = "GET"  name="refer">
...
<ul class="pagination justify-content-center" style="padding-top:30px;">
                                 <?php
                                  ...
                                  if(isset($_GET['search'])){
                                    ...
                                    $end = $_GET['end'];
                                    $coin12 = $_GET['type'];
                                    $prev="<li class='page-item'><a class='page-link btn btn-danger' href='deposit_history.php?page=$previous&&type=$coin12&&from=$date1&&to=$date2&&num=$limit&&start=$start1&&end=$end&&search=#start'>Previous</a></li>";
                                    $reset="<li class='page-item'><a class='page-link btn btn-info' href='deposit_history.php'>Reset</a></li>";
                                    $nxt ="<li class='page-item'><a class='page-link btn btn-primary' href='deposit_history.php?page=$next&&type=$coin12&&from=$date1&&to=$date2&&num=$limit&&start=$start1&&end=$end&&search=#start'>Next</a></li>";
                                  }elseif(isset($_GET['member'])){
                                    $member = $_GET['member'];
                                    $prev="<li class='page-item'><a class='page-link btn btn-danger' href='deposit_history.php?page=$previous&&member=$member&&member=#start'>Previous</a></li>";
                                    $reset="<li class='page-item'><a class='page-link btn btn-info' href='deposit_history.php'>Reset</a></li>";
                                    $nxt ="<li class='page-item'><a class='page-link btn btn-primary' href='deposit_history.php?page=$next&&member=$member&&member=#start'>Next</a></li>";
                                  }  else{
                                    $prev="<li class='page-item'><a class='page-link btn btn-danger' href='deposit_history.php?page=$previous#start'>Previous</a></li>";
                                    $reset="<li class='page-item'><a class='page-link btn btn-info' href='deposit_history.php'>Reset</a></li>";
                                    $nxt ="<li class='page-item'><a class='page-link btn btn-primary' href='deposit_history.php?page=$next#start'>Next</a></li>";
                                  }   
                                 
                                  if($page == 1){
                                    $prev = "<li class='page-item disabled'><a class='page-link btn btn-danger' href='deposit_history.php'>Previous</a></li>";
                                }
                                if($page == $pages OR $query_result == 0){
                          
                                    $nxt="<li class='page-item disabled'><a class='page-link btn btn-primary' href='deposit_history.php?page=$next'>Next</a></li>";
