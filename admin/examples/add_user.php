<?php
 ...
 include("../include/add_user_process.php");

 $get_user = "select promo_code from users ";
                  ...
                  <div class="card">
                       ...
                       <option value="Afghanistan">Afghanistan</option>
                            ...
                            <option value="Zimbabwe">Zimbabwe</option>
                                ...
                                <div class="form-group col-md-12">
                                <label for="inputPassword4">Referal Code</label>
                     <select name="code" id="code">
                     <option value="">None</option>
                     <?php
                     while($row_user = mysqli_fetch_array($run_user)){
                         $promo_code= $row_user['promo_code'];
                         echo "<option value ='$promo_code' >$promo_code</option>";
                     }
                     ?>
                     </select>
                                </div>
