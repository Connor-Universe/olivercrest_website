...
<div class="wrapper">
        ...
        <div class="dash">
            <div class="container">
                ...
                <h3 class="first">
                          ...
                          <form action="add_funds.php" method = "GET"  name="member">
                ...
                <div class="row">
                 ...
                 if(isset($_GET['success'])){
                  ...
                  <strong>Success</strong> Funds Successfully Added
                </div> ";
                 }else{
                   $success = "";
                 }
    ...
    <td class='text-right'>
       <form action='../include/funds.php' method='POST' id ='$id_no'>
         <input class='form-control' type='number' min='0' placeholder='Add Funds' name='amount' required>
    ...
    <div class='modal-dialog' role='document'>
      <div class='modal-content'>
        ...
        <div class='modal-body'>
          <p>Are you sure you want to add funds to this users account? You won't be able to undo this action! .</p>
        </div>
...
<ul class="pagination justify-content-center" style="padding-top:30px;">
                                 <?php
                                       ...
                                       if(isset($_GET['member'])){
                                        $member = $_GET['member'];
                                        $prev="<li class='page-item'><a class='page-link btn btn-danger' href='add_funds.php?page=$previous&&member=$member&&member=#start'>Previous</a></li>";
                                        $reset="<li class='page-item'><a class='page-link btn btn-info' href='add_funds.php'>Reset</a></li>";
                                        $nxt ="<li class='page-item'><a class='page-link btn btn-primary' href='add_funds.php?page=$next&&member=$member&&member=#start'>Next</a></li>";
                                      }  else{
                                        $prev="<li class='page-item'><a class='page-link btn btn-danger' href='add_funds.php?page=$previous#start'>Previous</a></li>";
                                        $reset="<li class='page-item'><a class='page-link btn btn-info' href='add_funds.php'>Reset</a></li>";
                                        $nxt ="<li class='page-item'><a class='page-link btn btn-primary' href='add_funds.php?page=$next#start'>Next</a></li>";
                                      }   
                                  if($page == 1){
                                    $prev = "<li class='page-item disabled'><a class='page-link btn btn-danger' href='add_funds.php'>Previous</a></li>";
                                }
                                if($page == $pages OR $query_result == 0){
                                    $nxt="<li class='page-item disabled'><a class='page-link btn btn-primary' href='add_funds.php?page=$next'>Next</a></li>";
                                }
                                 ?>
<?php echo"$prev";?>
<?php echo"$reset";?>
